...
namespace OnlineExamSystem.Controllers
{
    public class ProfileController : Controller
    {
        ...
        public ProfileController(ApplicationDbContext db, UserManager<UsersApp> um, IWebHostEnvironment env, ILogger<ProfileController> logger)
        {
            _db = db;
            _userManager = um;
            _env = env;
        ...
        public async Task<IActionResult> Edit()
        {
            ...
            if (roles.Contains(UserRoles.Admin.ToString()))
                ViewBag.ReturnUrl = Url.Action("AdminPage", "Role");
            else if (roles.Contains(UserRoles.Educator.ToString()))
                ViewBag.ReturnUrl = Url.Action("EducatorPage", "Exam");
            else if (roles.Contains(UserRoles.Student.ToString()))
                ViewBag.ReturnUrl = Url.Action("StudentPage", "Role");
        ...
        public async Task<IActionResult> EditProfile(UsersApp model, string? NewPassword, string? ConfirmPassword)
        {
